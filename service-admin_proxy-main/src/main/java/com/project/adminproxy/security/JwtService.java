...
public class JwtService {
    @Value("${com.project.adminproxy.jwt.signingKey}")
    private String jwtSigningKey;

    public String extractUserName(String token) { // should extract email
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        for (GrantedAuthority authority : userDetails.getAuthorities()) {
            allAuthorities.add(authority.getAuthority());
        }

        extraClaims.put("role", allAuthorities);
